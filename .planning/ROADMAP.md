...
- [x] 05-01-PLAN.md — Insights collection + revalidate hook + config registration + schema push (BLOG-02)
- [x] 05-02-PLAN.md — SEO metadata lib: getTranslatedLocales + buildAlternates + buildMetadata + NEXT_PUBLIC_SITE_URL (SEO-01/02/05)
- [x] 05-03-PLAN.md — Structured data lib: Organization/Product/BreadcrumbList JSON-LD + shared XSS-safe <JsonLd> + SiteSettings address/sameAs (SEO-04)
...
- [ ] 06-01-PLAN.md — Display-tier type-scale tokens, locale-scoped Geist display font, UI-SPEC amendment (wave 1)
