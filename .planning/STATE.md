...
| 260808-sp4 | Investigated 5 flagged pre-existing test failures instead of leaving them as noise: 2 were genuinely stale tests (RFQ subject format, revalidate call count both drifted from intentional code changes), fixed both. sitemap.spec.ts x3 confirmed via standalone reproduction to be a harness flake, shipped code proven correct. Suite: 92/97 -> 94/97 | 2026-08-08 | 16275e0 | [260808-sp4-stale-test-fixes](./quick/260808-sp4-stale-test-fixes/) |
| 260808-tcu | T-401: 3 full Insights posts researched + written + published (import documentation checklist, Incoterms for food buyers, IQF vs block-frozen) — generic industry content, web-researched, zero VNP-specific facts invented, safe to publish without owner review. Zero WCAG violations, insights.spec.ts 4/4 pass | 2026-08-08 | 95d1b31 | [260808-tcu-insights-first-3-posts-t401](./quick/260808-tcu-insights-first-3-posts-t401/) |
| 260808-u2v | Production deploy for T-401 failed: T-202's SiteSettings.resourceDocuments migration had a real schema bug (wrong pattern for mixed localized/non-localized array sub-fields). Fixed forward with a corrective migration verified against Products.downloads' correct shape, plus a real 11-min seed-script hang fix. Redeployed, verified live via curl against vnpglobal.in (/contact, /resources, /insights + 3 articles all 200) | 2026-08-08 | a77e951 | [260808-u2v-t202-migration-fix](./quick/260808-u2v-t202-migration-fix/) |
| 260808-vkd | T-206 reopened + real fix found: D-40's dynamic-import fix never worked (next/dynamic() doesn't code-split from a Server Component, documented Next.js limitation, not a bundler issue as previously concluded). Moved dynamic boundary into a proper Client Component. Verified via direct chunk inspection: 367KB react-hook-form chunk now loads only on /contact. Full regression clean after clearing accumulated stray processes | 2026-08-08 | 0b2c560 | [260808-vkd-t206-real-code-split-fix](./quick/260808-vkd-t206-real-code-split-fix/) |
| 260809-djh | 2 owner-observed bugs fixed: rich-text pages had zero CSS styling (bare h2/p/ul, browser defaults) - added shared .cms-richtext class using real design tokens across all 3 render sites. WhatsApp CTABandBlock was reading a per-page frozen seed-time href instead of the centralized SiteSettings number every other WhatsApp CTA already used - fixed to match, verified identical number across 6 page types | 2026-08-09 | PENDING | [260809-djh-richtext-formatting-whatsapp-centralize](./quick/260809-djh-richtext-formatting-whatsapp-centralize/) |
