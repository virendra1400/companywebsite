...
// TRUST-03: /[locale]/manufacturing renders a process-overview RichText and a
// MediaGallery of facility photos (>=4 fixed aspect-ratio cells, captions
// BELOW each image, never overlaid, no lightbox). No capacity/QC/cold-chain
// StatsBand — those figures were unverified placeholder content, removed.
// Both en and /ar paths are exercised to confirm no layout break under
// dir=rtl (UI-SPEC RTL Extensions — grid-based blocks need no extra RTL rules).
