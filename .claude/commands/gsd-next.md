...
<execution_context>
@/workspaces/companywebsite/.claude/gsd-core/workflows/smart-entry.md
...
<process>
Follow /workspaces/companywebsite/.claude/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
