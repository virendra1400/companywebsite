...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/workspaces/companywebsite/.claude/.gsd-surface.json`
(sibling to `/workspaces/companywebsite/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/workspaces/companywebsite/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/workspaces/companywebsite/.claude/skills`).
...
`/workspaces/companywebsite/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/workspaces/companywebsite/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/workspaces/companywebsite/.claude/.gsd-surface.json`
Install profile marker: `/workspaces/companywebsite/.claude/.gsd-profile`
Skill dirs: `/workspaces/companywebsite/.claude/skills/gsd-*/`
Engine module: `/workspaces/companywebsite/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/workspaces/companywebsite/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
