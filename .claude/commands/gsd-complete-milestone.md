...
- @/workspaces/companywebsite/.claude/gsd-core/workflows/complete-milestone.md (main workflow)
- @/workspaces/companywebsite/.claude/gsd-core/templates/milestone-archive.md (archive template)
  </execution_context>
