...
Key references:
- @/workspaces/companywebsite/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/workspaces/companywebsite/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/workspaces/companywebsite/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/workspaces/companywebsite/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/workspaces/companywebsite/.claude/gsd-core/USER-PROFILE.md" "/workspaces/companywebsite/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /workspaces/companywebsite/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/workspaces/companywebsite/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/workspaces/companywebsite/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /workspaces/companywebsite/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /workspaces/companywebsite/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /workspaces/companywebsite/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /workspaces/companywebsite/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /workspaces/companywebsite/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/workspaces/companywebsite/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /workspaces/companywebsite/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /workspaces/companywebsite/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /workspaces/companywebsite/.claude/CLAUDE.md
```
