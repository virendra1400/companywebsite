...
ones). Reference: @/workspaces/companywebsite/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /workspaces/companywebsite/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/workspaces/companywebsite/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/workspaces/companywebsite/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/workspaces/companywebsite/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/workspaces/companywebsite/.claude/gsd-core/templates/spec.md.
