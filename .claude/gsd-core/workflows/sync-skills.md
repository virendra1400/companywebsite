...
INSTALL_JS_GLOBAL="/workspaces/companywebsite/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /workspaces/companywebsite/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
