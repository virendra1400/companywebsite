...
```markdown
Read /workspaces/companywebsite/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /workspaces/companywebsite/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /workspaces/companywebsite/.claude/agents/gsd-ui-checker.md for instructions.
...
@/workspaces/companywebsite/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /workspaces/companywebsite/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/workspaces/companywebsite/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/workspaces/companywebsite/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
