...
```
Agent(
  prompt="Read /workspaces/companywebsite/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/workspaces/companywebsite/.claude/gsd-core/templates/SECURITY.md`
