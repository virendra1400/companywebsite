...
<template>
@/workspaces/companywebsite/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/workspaces/companywebsite/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/workspaces/companywebsite/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/workspaces/companywebsite/.claude/gsd-core/workflows/diagnose-issues.md
