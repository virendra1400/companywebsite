...
See /workspaces/companywebsite/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /workspaces/companywebsite/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /workspaces/companywebsite/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /workspaces/companywebsite/.claude/gsd-core/templates/discovery.md
...
Use /workspaces/companywebsite/.claude/gsd-core/templates/discovery.md.
