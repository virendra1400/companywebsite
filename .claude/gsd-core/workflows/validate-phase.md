...
```
Agent(
  prompt="Read /workspaces/companywebsite/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/workspaces/companywebsite/.claude/gsd-core/templates/VALIDATION.md`
