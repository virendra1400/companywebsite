...
<required_reading>
@/workspaces/companywebsite/.claude/gsd-core/references/ai-frameworks.md
@/workspaces/companywebsite/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /workspaces/companywebsite/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/workspaces/companywebsite/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /workspaces/companywebsite/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /workspaces/companywebsite/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /workspaces/companywebsite/.claude/agents/gsd-eval-planner.md for instructions.
