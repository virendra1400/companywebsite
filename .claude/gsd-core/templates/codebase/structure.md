...
- Usage: Reference from command with `@/workspaces/companywebsite/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /workspaces/companywebsite/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /workspaces/companywebsite/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
