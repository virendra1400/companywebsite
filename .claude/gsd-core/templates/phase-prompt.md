...
<!-- For checkpoint task examples and patterns, see @/workspaces/companywebsite/.claude/gsd-core/references/checkpoints.md -->
...
See `/workspaces/companywebsite/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/workspaces/companywebsite/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/workspaces/companywebsite/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
