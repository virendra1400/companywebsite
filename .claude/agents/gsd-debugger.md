...
<required_reading>
@/workspaces/companywebsite/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/workspaces/companywebsite/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspaces/companywebsite/.claude
                  → checks /workspaces/companywebsite/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspaces/companywebsite/.claude/gsd-core
                  → writes to /workspaces/companywebsite/.claude/gsd-core/hooks/
...
@/workspaces/companywebsite/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/workspaces/companywebsite/.claude/gsd-core/references/common-bug-patterns.md
