...
Reference full template: `/workspaces/companywebsite/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/companywebsite/.claude/gsd-core/templates/state.md`.
