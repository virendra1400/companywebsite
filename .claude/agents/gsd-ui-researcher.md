...
Use template from `/workspaces/companywebsite/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/workspaces/companywebsite/.claude/gsd-core/templates/UI-SPEC.md`
