...
<reference>
@/workspaces/companywebsite/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/workspaces/companywebsite/.claude/gsd-core/references/user-profiling.md` to load:
